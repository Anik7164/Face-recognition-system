"""
Facial Expression Recognition System - Main Application
Real-time emotion detection using webcam feed and deep learning CNN model
"""
...
class RealTimeEmotionDetection:
    def __init__(self, model_path):
        """Initialize the emotion detection system with a trained model"""
    ...
    def detect_emotions_from_camera(self):
        ...
        while True:
            ...
            faces = self.face_cascade.detectMultiScale(
                ...
                scaleFactor=1.1,
                minNeighbors=5,
                # Increased minimum size for better quality
                minSize=(100, 100),
            ...
            for (x, y, w, h) in faces:
                try:
                    ...
                    self.draw_confidence_bar(
                        frame, x, y+h+10, w, confidence, color)

                    # Draw all emotions probabilities (on the side)
                    self.draw_emotion_probabilities(
                        frame, predictions[0], x+w+10, y)
